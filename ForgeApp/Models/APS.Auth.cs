...
public partial class APS {
    ...
    public async Task<Tokens> GenerateTokens(string code)
    {
        ...
        var publicAuth = await authenticationClient.GetRefreshTokenAsync(_clientId, _clientSecret, internalAuth.RefreshToken, PublicTokenSccopes);
        return new Tokens
        {
    ...
    public async Task<Tokens> RefreshTokens(Tokens tokens)
    {
        ...
        var publicAuth = await authenticationClient.GetRefreshTokenAsync(_clientId, _clientSecret, internalAuth._RefreshToken, PublicTokenSccopes);
        return new Tokens
        {
            PublicToken = publicAuth.AccessToken,
            InternalToken = internalAuth.AccessToken,
